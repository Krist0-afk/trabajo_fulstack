...
public class VideojuegoControllerTest {
    ...
    void testGetAll() throws Exception {
        ...
        when(service.findAll()).thenReturn(List.of(new Videojuego(1L, "Tetris","PC",20,"Este juego es creativo")));
    ...
    void testPost() throws Exception {
        ...
        Videojuego v = new Videojuego( null, "Bubsy","SEGA Genesis",20,"Juego de un gato parecido al crash");

        //2 Simular con mockito el guardar este videojuego y me devuelve uno con el ud ya asignado
        when(service.save(any())).thenReturn(new Videojuego(1L,"Bubsy","SEGA Genesis",20,"Juego de un gato parecido al crash"));
            //3
    ...
    @Test
    @DisplayName("Testing Controller 4 -UPDATE")
